...
const FullscreenViewer = ({
  ...
  >
    ...
    {/* Thumbnail strip */}
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex gap-2 overflow-x-auto max-w-[90%] pb-2">
...
export default function PhotoGallery({
  ...
  }, [isViewerOpen, isAutoplay, nextSlide]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative h-80 overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-900">
        ...
        {/* Main image */}
        <div className="relative h-full w-full cursor-pointer" onClick={() => setIsViewerOpen(true)}>
          <Image
            src={photos[currentIndex].src}
            alt={photos[currentIndex].alt}
            fill
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/0 hover:bg-black/30 transition-all duration-300">
            <div className="bg-white/80 backdrop-blur-sm p-2 rounded-full opacity-0 hover:opacity-100 transition-opacity">
        ...
        <button
          ...
          className={`absolute top-4 right-4 z-20 p-2 rounded-full transition-colors text-xs font-medium ${
            isAutoplay
